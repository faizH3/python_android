...
while True:
        ...
        droid.ttsSpeak('kami memberikan beberapa fitur, jika kalian belum faham bagaimana cara kerjanya, silahkan pilih menu help.')
        droid.ttsSpeak('kami memberikan fitur dari mata kuliah semester yaitu kalkulus, matematika diskrit. program ini kami bangun untuk tujuan memudahkan pengerjaan dengan ketentuan yang sama dengan para pelajar yang merasa kebingungan di awal pelajaran mata kuliah')
        droid.ttsSpeak('berhubung kami masih semester 2, program ini hanya berlaku sesuai dengan peningkatan dari kami. terimakasih.')
        droid.ttsSpeak('tapi kami akan berusaha terus mengembangkan program ini seiring dengan kami naik ke semester berikutnya. kami akan menambahkan fitur-fitur di semester berikutnya terimakasih')
        print("=================================================================")
